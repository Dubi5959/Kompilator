...
procedureHeader* proc_head_function(string* s, std::vector<std::pair<std::string*,bool>>* argumentsList, long long a){
...
void setMain(){
    currentScope="mainScope";
     cout << "Debug setMain \n";
    // cout  << " | pair: | " << myPair.first.at(0).name << " | " << myPair.second <<  "\n";
}; 
